        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.trainer.update', $trainer->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <img src="{{ $trainer->image_path }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div>
